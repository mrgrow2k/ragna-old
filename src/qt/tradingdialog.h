...
private slots:
    ...
    QString BuyRAGNA(QString OrderType, double Quantity, double Rate);
    QString SellRAGNA(QString OrderType, double Quantity, double Rate);
