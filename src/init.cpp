...
std::string HelpMessage()
{
    ...
    strUsage += "  -conf=<file>           " + _("Specify configuration file (default: ragnarok.conf)") + "\n";
    strUsage += "  -pid=<file>            " + _("Specify pid file (default: ragnarokd.pid)") + "\n";
...
strUsage += "\n" + _("Masternode options:") + "\n";
    ...
    strUsage += "  -anonymizeragnarokamount=<n> " + _("Keep N Ragnarok anonymized (default: 0)") + "\n";
...
#define PROCESS_DEP_ENABLE 0x00000001
    ...
    // Sanity check
    if (!InitSanityCheck())
        return InitError(_("Initialization sanity check failed. Ragnarok is shutting down."));
    ...
    if (!lock.try_lock())
        return InitError(strprintf(_("Cannot obtain a lock on data directory %s. Ragnarok is probably already running."), strDataDir));
    ...
    /* Denominations
       ...
       For example:
       1RAGNA+1000 == (.1RAGNA+100)*10
       10RAGNA+10000 == (1RAGNA+1000)*10
    */
